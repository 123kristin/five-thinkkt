...
def test_difficulty_ranking():
    ...
    config = {
        ...
        'difficulty_csv_path': 'test_difficulty_vcrkt.csv',  # 测试用的难度数据文件
        'dataset_name': 'test'
    }
    ...
    # 创建测试用的难度数据文件
    create_test_difficulty_csv('test_difficulty_vcrkt.csv', config['num_q'])
    ...
    # 清理测试文件
    if os.path.exists('test_difficulty_vcrkt.csv'):
        os.remove('test_difficulty_vcrkt.csv')
