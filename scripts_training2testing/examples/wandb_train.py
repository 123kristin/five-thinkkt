...
def main(params):
    ...
    params_str = "_".join( [str(v) for k,v in params_for_str.items() if k not in ['seed', 'save_dir', 'add_uuid', 'other_config', 'emb_path', 'gen_emb_path', 'difficulty_path', 'gen_kc_emb_file', 'use_wandb', 'num_epochs', 'gpu_id']] )
