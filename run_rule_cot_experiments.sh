...
echo "Launching DBE_KT22 on GPU 0..."
{
    ...
    echo "DBE CRKT finished. Running DBE Visual..."
    python scripts/run_all_thinkkt_experiments.py \
        --gpu_id 1 \
...
echo "Launching XES3G5M on GPU 1..."
{
    ...
    echo "XES CRKT finished. Running XES Visual..."
    python scripts/run_all_thinkkt_experiments.py \
        --gpu_id 0 \
...
echo "Launching nips_task34 on GPU 2..."
{
    ...
    echo "NIPS CRKT finished. Running NIPS Visual..."
    python scripts/run_all_thinkkt_experiments.py \
        --gpu_id 2 \
